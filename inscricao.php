              ...
              <form action="inseriraluno.php" method="Post">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    ...
                    <option value="Desenvolvimento Movel">Desenvolvimento Movel</option>
                    <option value="Desenvolvimento Web-Back End">Desenvolvimento Web-Back End</option>
                    <option value="Análise e Projeto de Software">Análise e Projeto de Software</option>
                    <option value="Banco de dados">Banco de dados</option>
                    ...
                    <option value="Embriologia e Histologia Animal Comparada ">Embriologia e Histologia Animal Comparada </option>
