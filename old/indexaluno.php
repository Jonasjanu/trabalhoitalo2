...
<body class="text-center">
  ...
  <input type="email" id="inputEmail" class="form-control" placeholder="Email" required autofocus><br><br>
  ...
  <p class="mt-5 mb-3 text-muted"></p>
      ...
      <div align="right">
        <a href='paglogin.html' 
         >Admin</a>
      </div>

      <div align="center" method="POST" action = "pagi01italo.html">
      <button style="width:150;height:60"><a href="pag01.html"> Inscrição de Aluno </a></button>
      </div>
